...
interface PengelolaRekening {
    void bukaRekening(Nasabah nasabah);
    
    static String generateNomorRekening() {
...
abstract class Nasabah {
    ...
    public abstract double hitungBiayaAdmin();
...
final class NasabahIndividu extends Nasabah {
    private String npwp;
...
final class NasabahPerusahaan extends Nasabah {
...
final class NasabahPremium extends Nasabah {
...
final class BankSyariah implements PengelolaRekening {
    private final ArrayList<Nasabah> dataNasabah = new ArrayList<>();
    private final ArrayList<Transaksi> dataTransaksi = new ArrayList<>();
    private final Random random = new Random();

    @Override
    public void bukaRekening(Nasabah nasabah) {
...
public class App {
    ...
    if (!dataNasabahDitambahkan) {
        ...
        if (jenisNasabah.equalsIgnoreCase("I")) {
            ...
            bankSyariah.bukaRekening(new NasabahIndividu(nama, "", "", nomorKTP, alamat, tanggalLahir, namaIbuKandung, pekerjaan, npwp));
            ...
            bankSyariah.bukaRekening(new NasabahPerusahaan(nama, "", "", nomorKTP, alamat, tanggalLahir, namaIbuKandung, pekerjaan, namaPerusahaan, npwpPerusahaan));
        } else {
